...
@kgrid/cli/0.4.4 win32-x64 node-v10.15.1
$ kgrid --help [COMMAND]
USAGE
  $ kgrid COMMAND
...
...
_See code: [src\commands\create-manifest.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src\commands\create-manifest.js)_
...
OPTIONS
  ...
  -h, --help                     show CLI help
  -m, --manifest                 Generate a manifest after packaging
  -s, --source=source            The folder holding the kos as the source directory
...
_See code: [src\commands\package-all.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src\commands\package-all.js)_
