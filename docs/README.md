...
@kgrid/cli/0.4.2 linux-x64 node-v12.13.1
$ kgrid --help [COMMAND]
USAGE
  $ kgrid COMMAND
...
...
_See code: [src/commands/create.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/create.js)_
...
_See code: [src/commands/list.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/list.js)_
...
_See code: [src/commands/package.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/package.js)_
...
_See code: [src/commands/play.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/play.js)_
...
_See code: [src/commands/setup.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/setup.js)_
...
_See code: [src/commands/start/index.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/start/index.js)_
...
_See code: [src/commands/start/activator.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/start/activator.js)_
...
_See code: [src/commands/start/library.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/start/library.js)_
...
_See code: [src/commands/upload.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.2/src/commands/upload.js)_
<!-- commandsstop -->
