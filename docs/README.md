...
@kgrid/cli/0.4.1 linux-x64 node-v12.13.1
$ kgrid --help [COMMAND]
USAGE
  $ kgrid COMMAND
...
...
running command...
$ kgrid (-v|--version|version)
@kgrid/cli/0.4.0a win32-x64 node-v10.16.3
$ kgrid --help [COMMAND]
USAGE
  $ kgrid COMMAND
...
...
_See code: [src/commands/create.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/create.js)_
...
_See code: [src/commands/list.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/list.js)_
...
_See code: [src/commands/package.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/package.js)_
...
_See code: [src/commands/play.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/play.js)_
...
_See code: [src/commands/setup.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/setup.js)_
...
_See code: [src/commands/start/index.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/start/index.js)_
...
_See code: [src/commands/start/activator.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/start/activator.js)_
...
_See code: [src/commands/start/library.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/start/library.js)_
...
_See code: [src/commands/upload.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.1/src/commands/upload.js)_
<!-- commandsstop -->
* [`kgrid create [KO]`](#kgrid-create-ko)
* [`kgrid help [COMMAND]`](#kgrid-help-command)
* [`kgrid list`](#kgrid-list)
...
_See code: [src\commands\create.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\create.js)_
...
_See code: [src\commands\list.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\list.js)_
...
_See code: [src\commands\package.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\package.js)_
...
_See code: [src\commands\play.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\play.js)_
...
_See code: [src\commands\setup.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\setup.js)_
...
_See code: [src\commands\start\index.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\start\index.js)_
...
_See code: [src\commands\start\activator.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\start\activator.js)_
...
_See code: [src\commands\start\library.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\start\library.js)_
...
_See code: [src\commands\upload.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.0a/src\commands\upload.js)_
<!-- commandsstop -->
