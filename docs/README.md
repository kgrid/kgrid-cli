...
@kgrid/cli/0.5.0 win32-x64 node-v10.17.0
$ kgrid --help [COMMAND]
USAGE
  $ kgrid COMMAND
...
...
running command...
$ kgrid (-v|--version|version)
@kgrid/cli/0.5.0 win32-x64 node-v10.15.1
$ kgrid --help [COMMAND]
USAGE
  $ kgrid COMMAND
...
...
running command...
$ kgrid (-v|--version|version)
@kgrid/cli/0.4.4 linux-x64 node-v12.14.1
$ kgrid --help [COMMAND]
USAGE
  $ kgrid COMMAND
...
...
_See code: [src\commands\create.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\create.js)_
...
_See code: [src\commands\create-manifest.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\create-manifest.js)_
...
_See code: [src\commands\list.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\list.js)_
...
_See code: [src\commands\package.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\package.js)_
...
_See code: [src\commands\package-all.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\package-all.js)_
...
_See code: [src\commands\play.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\play.js)_
...
_See code: [src\commands\setup.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\setup.js)_
...
_See code: [src\commands\start\index.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\start\index.js)_
...
_See code: [src\commands\start\activator.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\start\activator.js)_
...
_See code: [src\commands\start\library.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\start\library.js)_
...
_See code: [src\commands\upload.js](https://github.com/kgrid/kgrid-cli/blob/v0.5.0/src\commands\upload.js)_
<!-- commandsstop -->
* [`kgrid create [KO]`](#kgrid-create-ko)
* [`kgrid create-manifest`](#kgrid-create-manifest)
* [`kgrid help [COMMAND]`](#kgrid-help-command)
...
_See code: [src/commands/create.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/create.js)_
...
_See code: [src/commands/list.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/list.js)_
...
_See code: [src/commands/package.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/package.js)_


## `kgrid package-all`

Package all knowledge objects in the current directory or one specified with the -s option.
...
OPTIONS
  ...
  -h, --help                     show CLI help
  -s, --source=source            the folder holding the kos as the source directory
  -m --manifest                  a manifest pointing to all of the zipped kos will be generated alongside the zipped files

DESCRIPTION
  The package command will package the specified KOs into ZIP files, ready for depositing into a KGrid Library or
  deploying to a KGrid Activator.

  The flag --source can be used to specify the directory for the knowledge objects you'd like to package.
  
  To generate a manifest for the packaged kos use the flag -m or --manifest.

```

_See code: [src/commands/package-all.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/package.js)_
...
_See code: [src/commands/play.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/play.js)_
...
_See code: [src/commands/setup.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/setup.js)_
...
_See code: [src/commands/start/index.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/start/index.js)_
...
_See code: [src/commands/start/activator.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/start/activator.js)_
...
_See code: [src/commands/start/library.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/start/library.js)_
...
_See code: [src/commands/upload.js](https://github.com/kgrid/kgrid-cli/blob/v0.4.4/src/commands/upload.js)_
<!-- commandsstop -->
